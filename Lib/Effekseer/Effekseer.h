...
public:
	...
	*/
	static Effect* Create( Manager* manager, void* data, int32_t size, const EFK_CHAR* materialPath = NULL );
	...
	/**
		...
		@return	エフェクト。失敗した場合はNULLを返す。
	*/
	static Effect* Create( Manager* manager, const EFK_CHAR* path, const EFK_CHAR* materialPath = NULL );
...
public:
	...
	virtual void BeginRendering( const NodeParamater& paramater, int32_t count, void* userData ) {}
